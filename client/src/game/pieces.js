/**
 * pieces.js — High-quality "Neo" Staunton SVG chess pieces
 *
 * The cburnett set — the industry-standard open-source piece set used
 * by Lichess and Chess.com. Perfectly symmetric (except Knight, which
 * faces left by convention). All pieces centered in a 45×45 viewBox.
 */
...
PIECE_SVG['wK'] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  <g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M12.5 37c5.5 3.5 14.5 3.5 20 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10 5 10V37z" fill="#fff"/>
...
PIECE_SVG['wQ'] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  <g fill="#fff" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M9 26c8.5-1.5 21-1.5 27 0l2.5-12.5L31 25l-3.5-12.5-5 15-5-15L14 25 6.5 13.5 9 26z" stroke-linecap="butt"/>
...
PIECE_SVG['wP'] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03C15.41 27.09 11 31.58 11 39.5h23c0-7.92-4.41-12.41-7.41-13.47A5.98 5.98 0 0 0 29 21c0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z" fill="#fff" stroke="#000" stroke-width="1.5" stroke-linecap="round"/>
</svg>`;
...
PIECE_SVG['bK'] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  <g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="M22.5 11.63V6" stroke-linejoin="miter"/>
    <path d="M22.5 6l2 2h-4l2-2z" fill="#000" stroke-linejoin="miter"/>
    <path d="M20 8h5" stroke-linejoin="miter"/>
    ...
    <path d="M12.5 37c5.5 3.5 14.5 3.5 20 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10 5 10V37z" fill="#000"/>
...
PIECE_SVG['bQ'] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  <g fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M9 26c8.5-1.5 21-1.5 27 0l2.5-12.5L31 25l-3.5-12.5-5 15-5-15L14 25 6.5 13.5 9 26z" fill="#000" stroke-linecap="butt"/>
...
PIECE_SVG['bR'] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  <g fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="M9 39h27v-3H9v3z" fill="#000" stroke-linecap="butt"/>
    <path d="M12.5 32l1.5-2.5h17l1.5 2.5h-20z" fill="#000" stroke-linecap="butt"/>
    <path d="M12 36v-4h21v4H12z" fill="#000" stroke-linecap="butt"/>
    <path d="M14 29.5v-13h17v13H14z" fill="#000" stroke-linecap="butt" stroke-linejoin="miter"/>
    <path d="M14 16.5L11 14h23l-3 2.5H14z" fill="#000" stroke-linecap="butt"/>
    <path d="M11 14V9h4v2h5V9h5v2h5V9h4v5H11z" fill="#000" stroke-linecap="butt"/>
    <path d="M12 36l-1 2.5h23l-1-2.5H12z" fill="#000" stroke-linecap="butt"/>
    <path d="M17 16.5v13M21 16.5v13M26 16.5v13" fill="none" stroke="#fff" stroke-width="1" stroke-linejoin="miter"/>
    <path d="M11 14h23" fill="none" stroke-linejoin="miter"/>
  </g>
</svg>`;
...
PIECE_SVG['bN'] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  <g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M24.55 10.4l-.45 1.45.5.15c3.15 1 5.65 2.49 7.9 6.75S35.75 29.06 35.25 39l-.05.5h2.25l.05-.5c.5-10.06-.88-16.85-3.25-21.34-2.37-4.49-5.11-6.26-8.58-7.41l-.12-.04z" fill="#fff" stroke="none"/>
  </g>
</svg>`;

PIECE_SVG['bP'] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03C15.41 27.09 11 31.58 11 39.5h23c0-7.92-4.41-12.41-7.41-13.47A5.98 5.98 0 0 0 29 21c0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z" fill="#000" stroke="#000" stroke-width="1.5" stroke-linecap="round"/>
</svg>`;

/* ─── Standalone large knight for hero decoration ─── */
export const HERO_KNIGHT_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  <g fill="none" fill-rule="evenodd" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    <path d="M22 10c10.5 1 16.5 8 16 29H15c0-9 10-6.5 8-21" fill="url(#knightGrad)" stroke="rgba(255,255,255,0.3)"/>
    <path d="M24 18c.38 2.91-5.55 7.37-8 9-3 2-2.82 4.34-5 4-1.042-.94 1.41-3.04 0-3-1 0 .19 1.23-1 2-1 0-4.003 1-4-4 0-2 6-12 6-12s1.89-1.9 2-3.5c-.73-.994-.5-2-.5-3 1-1 3 2.5 3 2.5h2s.78-1.992 2.5-3c1 0 1 3 1 3" fill="url(#knightGrad)" stroke="rgba(255,255,255,0.3)"/>
    ...
    <defs>
      <linearGradient id="knightGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="#4B8B9B"/>
